import cv2
from HandDetector import HandDetector  # Check the correct module name
import numpy as np
import math
import time
...
offset = 30
imgSize = 300
folder = r"C:\Users\jimve\Documents\CEG-HACKATHON\DATA\A"
...
while True:
    ...
    if key == ord("s"):  # Change from "a" to "s"
        counter += 1
